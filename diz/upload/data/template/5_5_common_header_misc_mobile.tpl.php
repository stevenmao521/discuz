...
0
|| checktplrefresh('./template/ttstyle/common/header.htm', './template/default/common/header_common.htm', 1596174428, '5', './data/template/5_5_common_header_misc_mobile.tpl.php', './template/ttstyle', 'common/header_misc_mobile')
|| checktplrefresh('./template/ttstyle/common/header.htm', './template/ttstyle/common/header_style.htm', 1596174428, '5', './data/template/5_5_common_header_misc_mobile.tpl.php', './template/ttstyle', 'common/header_misc_mobile')
|| checktplrefresh('./template/ttstyle/common/header.htm', './template/default/common/header_qmenu.htm', 1596174428, '5', './data/template/5_5_common_header_misc_mobile.tpl.php', './template/ttstyle', 'common/header_misc_mobile')
|| checktplrefresh('./template/ttstyle/common/header.htm', './template/ttstyle/common/header_userstatus.htm', 1596174428, '5', './data/template/5_5_common_header_misc_mobile.tpl.php', './template/ttstyle', 'common/header_misc_mobile')
|| checktplrefresh('./template/ttstyle/common/header.htm', './template/ttstyle/common/pubsearchform.htm', 1596174428, '5', './data/template/5_5_common_header_misc_mobile.tpl.php', './template/ttstyle', 'common/header_misc_mobile')
;?>
